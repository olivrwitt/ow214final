...
for (i in 1:nrow(bis_window_1)) {
  ...
  `NH4-N` <- cleaned_bis_1$`NH4-N`[
    cleaned_bis_1$Sample_Date >= w1 & cleaned_bis_1$Sample_Date < w2
  ]
  `NO3-N` <- cleaned_bis_1$`NO3-N`[
    cleaned_bis_1$Sample_Date >= w1 & cleaned_bis_1$Sample_Date < w2
  ]
  K <- cleaned_bis_1$K[
    cleaned_bis_1$Sample_Date >= w1 & cleaned_bis_1$Sample_Date < w2
...
for (i in 1:nrow(bis_window_2)) {
  ...
  `NH4-N` <- cleaned_bis_2$`NH4-N`[
    cleaned_bis_2$Sample_Date >= w1 & cleaned_bis_2$Sample_Date < w2
  ]
  `NO3-N` <- cleaned_bis_2$`NO3-N`[
    cleaned_bis_2$Sample_Date >= w1 & cleaned_bis_2$Sample_Date < w2
  ]
  K <- cleaned_bis_2$K[
    cleaned_bis_2$Sample_Date >= w1 & cleaned_bis_2$Sample_Date < w2
...
for (i in 1:nrow(bis_window_3)) {
  ...
  `NH4-N` <- cleaned_bis_3$`NH4-N`[
    cleaned_bis_3$Sample_Date >= w1 & cleaned_bis_3$Sample_Date < w2
  ]
  `NO3-N` <- cleaned_bis_3$`NO3-N`[
    cleaned_bis_3$Sample_Date >= w1 & cleaned_bis_3$Sample_Date < w2
  ]
  K <- cleaned_bis_3$K[
    cleaned_bis_3$Sample_Date >= w1 & cleaned_bis_3$Sample_Date < w2
...
for (i in 1:nrow(prm_window)) {
  ...
  `NH4-N` <- cleaned_prm$`NH4-N`[
    cleaned_prm$Sample_Date >= w1 & cleaned_prm$Sample_Date < w2
  ]
  `NO3-N` <- cleaned_prm$`NO3-N`[
    cleaned_prm$Sample_Date >= w1 & cleaned_prm$Sample_Date < w2
  ]
  K <- cleaned_prm$K[
    cleaned_prm$Sample_Date >= w1 & cleaned_prm$Sample_Date < w2
